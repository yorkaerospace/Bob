...
data::data()
{
    ...
    this->flight_state = stdio_usb_connected() ? TESTING : GROUNDED;
    this->sensor_state = NO_FAULT;
}

/* Initialises the sensors and the associated i2c bus */
void configureSensors(data *dat)
{
